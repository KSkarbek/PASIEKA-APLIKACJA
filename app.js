...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // WAŻNE: Skopiuj adres z Apps Script i wklej go tutaj między apostrofy:
  ...
  // === OBSŁUGA KLIKNIĘĆ I PRZYCISKÓW NA KAFELKACH ULA ===
  document.addEventListener('click', e => {
    ...
    if (actionBtn) {
      ...
      if (actionBtn.classList.contains('btn-delete-inspection')) {
  ...
  function renderHivesGrid() {
    ...
    for (let i = 1; i <= TOTAL_HIVES; i++) {
      ...
      card.innerHTML = `
        ...
        <!-- TYLKO 3 PRZYCISKI NA DOLE -->
        <div class="hive-card-footer" style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 4px; margin-top: 10px;">
          <button class="btn-card-action primary btn-add-inspection" data-hive="${i}" style="font-size:0.8rem; padding:6px 2px;" title="Przegląd">📝 Przegląd</button>
          <button class="btn-card-action btn-add-feeding" data-hive="${i}" style="background: #d97706; color: white; font-size:0.8rem; padding:6px 2px;" title="Karmienie">🍯 Karmienie</button>
          <button class="btn-card-action btn-add-treatment" data-hive="${i}" style="background: #dc2626; color: white; font-size:0.8rem; padding:6px 2px;" title="Leczenie">💉 Leczenie</button>
        </div>
